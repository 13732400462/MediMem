...
from .agents import case_context, run_llm_prediction
...
def run_ddo_adapter(case: dict[str, Any], client: DeepSeekClient | None) -> dict[str, Any]:
...
def run_colacare_adapter(case: dict[str, Any], client: DeepSeekClient | None) -> dict[str, Any]:
...
def run_baseline(name: str, case: dict[str, Any], client: DeepSeekClient | None) -> dict[str, Any]:
    if name == "ddo":
        return run_ddo_adapter(case, client)
    if name == "colacare":
        return run_colacare_adapter(case, client)
